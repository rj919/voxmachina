...
def monitor_telegram(telegram_config):
    ...
    from labpack.storage.appdata import appdataClient
    telegram_data_client = appdataClient('Knowledge', prod_name='Fitzroy')
    ...
    if updates_details['json']['result']:
        ...
        telegram_data_client.create('counts/%s' % update_key, offset_details)
    for update in update_list:
        ...
        from server.bot_fitzroy import bot_client
